    ...
    const mutator = useMutation(
        ...
        },
        {
            onError: (error: any) => {
                ...
                alertService.error(error.data.message || t('Something went wrong, please try again'));
            },
            onSuccess: (data: any) => {
                // Boom baby!
                if (id) {
                    alertService.success(t('Announcement was updated successfully'));
                } else {
                    alertService.success(t('Announcement was created successfully'));
    ...
    return (
        <div>
            <FormComp
                ...
                title={id ? 'Update Announcement' : t('Create New Announcement')}
