export const __FooterStyles = {
    ...
    firstRowDesc: 'text-stone-800 dark:text-stone-100 mb-1',
    lastRow:
        'text-sm text-stone-800 dark:text-stone-100 mb-2 mt-16 border-t border-teal-800 flex flex-col items-center',
    lastRowContainer: 'sm:w-2/3 text-center py-6',
    lastRowItem: 'px-2',
};
