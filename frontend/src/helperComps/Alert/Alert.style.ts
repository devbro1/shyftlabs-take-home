export const __AlertStyles = {
    info: {
        wrapper: 'flex p-4 mb-4 bg-blue-100 rounded-lg dark:bg-blue-200 w-96',
        message: 'ml-3 text-sm font-medium text-blue-700 dark:text-blue-800',
        closeButton:
    ...
    error: {
        wrapper: 'flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200 w-96',
        message: 'ml-3 text-sm font-medium text-red-700 dark:text-red-800',
        closeButton:
    ...
    success: {
        wrapper: 'flex p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 w-96',
        message: 'ml-3 text-sm font-medium text-green-700 dark:text-green-800',
        closeButton:
    ...
    warning: {
        wrapper: 'flex p-4 mb-4 bg-yellow-100 rounded-lg dark:bg-yellow-200 w-96',
        message: 'ml-3 text-sm font-medium text-yellow-700 dark:text-yellow-800',
        closeButton:
    ...
    dark: {
        wrapper: 'flex p-4 bg-gray-100 rounded-lg dark:bg-gray-700 w-96',
        message: 'ml-3 text-sm font-medium text-gray-700 dark:text-gray-300',
        closeButton:
