...
INTRO
    ...
    'groups' => [
        ...
        'default' => 'Undocumented Endpoints',
    ...
    'strategies' => [
        ...
        'bodyParameters' => [
            ...
            App\Docs\Strategies\UseTestResultsbodyParameters::class,
        ],
        'responses' => [
            ...
            App\Docs\Strategies\UseTestResultsResponses::class,
        ],
        'responseFields' => [
